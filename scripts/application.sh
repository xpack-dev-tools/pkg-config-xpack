...
XBB_APPLICATION_NAME=${XBB_APPLICATION_NAME:-"pkg-config"}

# Used as part of file/folder paths.
XBB_APPLICATION_LOWER_CASE_NAME=${XBB_APPLICATION_LOWER_CASE_NAME:-"pkg-config"}
...
declare -a XBB_APPLICATION_COMMON_DEPENDENCIES=( libiconv pkg-config )
