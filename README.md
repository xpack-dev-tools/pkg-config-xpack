...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/pkg-config?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/pkg-config/)
...
[project web site](https://xpack-dev-tools.github.io/pkg-config-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v0.29.2-3.1 tree](https://github.com/xpack-dev-tools/pkg-config-xpack/tree/v0.29.2-3.1).
