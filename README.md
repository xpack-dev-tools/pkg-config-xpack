...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/pkg-config?color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/pkg-config/)
...
distribution of pkg-config,
intended for reproducible builds.

## Project documentation

For information on how to install and use this project, please refer to the
[project website](https://xpack-dev-tools.github.io/pkg-config-xpack/).

## Project source

The source code of the current release is available on
GitHub as [xpack-dev-tools/pkg-config-xpack](https://github.com/xpack-dev-tools/pkg-config-xpack),
the [v0.29.2-3.1](https://github.com/xpack-dev-tools/pkg-config-xpack/tree/v0.29.2-3.1) tree.
