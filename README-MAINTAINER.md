...
git pull -C ~/Work/pkg-config-xpack.git
...
total 224
-rw-r--r--  1 ilg  staff  109290 Oct 24 23:28 xpack-pkg-config-0.29.2-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff     108 Oct 24 23:28 xpack-pkg-config-0.29.2-1-darwin-x64.tar.gz.sha
```
...
total 200
-rw-r--r--  1 ilg  staff  95328 Oct 24 23:28 xpack-pkg-config-0.29.2-1-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff    110 Oct 24 23:28 xpack-pkg-config-0.29.2-1-darwin-arm64.tar.gz.sha
```
...
xpm install --config linux-x64 -C ~/Work/pkg-config-xpack.git
xpm run build-develop --config linux-x64 -C ~/Work/pkg-config-xpack.git
```
...
total 904
-rw-r--r-- 1 root root 918500 Oct 24 20:29 xpack-pkg-config-0.29.2-1-linux-x64.tar.gz
-rw-r--r-- 1 root root    107 Oct 24 20:29 xpack-pkg-config-0.29.2-1-linux-x64.tar.gz.sha
```
...
xpm install --config linux-arm64 -C ~/Work/pkg-config-xpack.git
xpm run build-develop --config linux-arm64 -C ~/Work/pkg-config-xpack.git
```
...
total 848
-rw-r--r-- 1 root root 863136 Oct 24 20:31 xpack-pkg-config-0.29.2-1-linux-arm64.tar.gz
-rw-r--r-- 1 root root    109 Oct 24 20:31 xpack-pkg-config-0.29.2-1-linux-arm64.tar.gz.sha
```
...
xpm install --config linux-arm -C ~/Work/pkg-config-xpack.git
xpm run build-develop --config linux-arm -C ~/Work/pkg-config-xpack.git
```
...
total 796
-rw-r--r-- 1 root root 807383 Oct 24 20:31 xpack-pkg-config-0.29.2-1-linux-arm.tar.gz
-rw-r--r-- 1 root root    107 Oct 24 20:31 xpack-pkg-config-0.29.2-1-linux-arm.tar.gz.sha
```
...
```sh
bash ~/Work/pkg-config-xpack.git/scripts/helper/trigger-workflow-build.sh --machine xbbli
bash ~/Work/pkg-config-xpack.git/scripts/helper/trigger-workflow-build.sh --machine xbbla64
bash ~/Work/pkg-config-xpack.git/scripts/helper/trigger-workflow-build.sh --machine xbbla32
bash ~/Work/pkg-config-xpack.git/scripts/helper/trigger-workflow-build.sh --machine xbbmi
bash ~/Work/pkg-config-xpack.git/scripts/helper/trigger-workflow-build.sh --machine xbbma
```
...
```sh
bash ~/Work/pkg-config-xpack.git/scripts/helper/tests/trigger-workflow-test-prime.sh
bash ~/Work/pkg-config-xpack.git/scripts/helper/tests/trigger-workflow-test-docker-linux-intel.sh
bash ~/Work/pkg-config-xpack.git/scripts/helper/tests/trigger-workflow-test-docker-linux-arm.sh
```
...
```sh
bash ~/Work/pkg-config-xpack.git/scripts/helper/tests/trigger-travis-macos.sh
```
...
[release](https://github.com/pkg-config/ninja/releases/).
...
- `npm unpublish @xpack-dev-tools/pkg-config@0.29.2-1.X`
