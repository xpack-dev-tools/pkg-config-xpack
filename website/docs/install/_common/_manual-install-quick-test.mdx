...
`% ~/Library/xPacks/${props.shortName}/xpack-${props.shortName}-0.29.2-3/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.shortName}/xpack-${props.shortName}-0.29.2-3/bin/${props.programName} --version
${props.branding}0.29.2
`} </CodeBlock>
