...
The **xPack pkg-config** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack pkg-config
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/pkg-config/0.29.2-3.1/.content/bin:$PATH
`} </CodeBlock>
