...
`% ~/Library/xPacks/@xpack-dev-tools/${props.shortName}/0.29.2-3.1/.content/bin/${props.programName} --version
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@xpack-dev-tools/${props.shortName}/0.29.2-3.1/.content/bin/${props.programName} --version
${props.branding}0.29.2
`} </CodeBlock>
