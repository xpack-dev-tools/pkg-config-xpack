...
title: Getting Started with xPack pkg-config
...
![GitHub Repo stars](https://img.shields.io/github/stars/xpack-dev-tools/pkg-config-xpack)

## Overview

**xPack pkg-config** is a standalone
cross-platform (GNU/Linux, macOS)binary distribution of pkg-config,
intended for reproducible builds.

<Overview/>

The open source **xPack pkg-config** project is hosted on GitHub as
...
[release assets](https://github.com/xpack-dev-tools/pkg-config-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/pkg-config-xpack/tree/xpack/build-assets/scripts).
...
[GitHub Discussions](https://github.com/xpack-dev-tools/pkg-config-xpack/discussions/).
...
[`pkg-config-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/pkg-config-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/pkg-config-xpack/): It helps others discover our work.
