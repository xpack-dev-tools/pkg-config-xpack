...
**xPack pkg-config** is a standalone cross-platform (Windows, macOS, GNU/Linux)
binary distribution of pkg-config,
intended for reproducible builds.

<Overview/>

**xPack pkg-config** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/pkg-config-xpack/tree/xpack/scripts).
