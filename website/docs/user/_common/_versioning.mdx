...
upstream {props.upstreamName ? props.upstreamName : 'pkg-config'} project
is a three-number string
such as <code>0.29.2</code>;
...
such as <code>0.29.2-<b>3</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>0.29.2-3.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack pkg-config dependency via
SemVer expressions
such as <code>^0.29.2-3</code> or <code>~0.29.2-3</code>, and
prefer exact matches,
such as <code>0.29.2-3.1</code>.
