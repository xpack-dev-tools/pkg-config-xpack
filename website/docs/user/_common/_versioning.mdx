...
like <code>0.29.2-<b>3</b></code>. When
published as a npm package, the version gets
a fifth number,
like <code>0.29.2-3.<b>1</b></code>.

Since adherence of third party packages to SemVer is not guaranteed,
it is recommended to avoid referring to the xPack pkg-config dependency via
a SemVer expressions
like <code>^0.29.2-3</code> or <code>~0.29.2-3</code>, and
prefer exact matches,
like <code>0.29.2-3.1</code>.
