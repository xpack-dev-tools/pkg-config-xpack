...
title: Information for xPack pkg-config maintainers
...
```sh
bash ~/Work/xpack-dev-tools/pkg-config-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack pkg-config v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/pkg-config</code>
- <code>npm dist-tag add @xpack-dev-tools/pkg-config@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/pkg-config</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/pkg-config@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/pkg-config-xpack/blog/
...
- paste the release name like _**xPack pkg-config v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
