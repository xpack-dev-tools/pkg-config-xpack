...
# How to get help for the xPack pkg-config
...
similar topics
- Check the [GitHub Issues](https://github.com/xpack-dev-tools/pkg-config-xpack/issues)
tracker and the
...
others, please 
use the [GitHub Discussions](https://github.com/xpack-dev-tools/pkg-config-xpack/discussions)
pages.
