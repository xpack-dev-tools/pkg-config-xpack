...
title: How to get help for pkg-config
...
# How to get help for xPack pkg-config
...
distribution, not to the upstream pkg-config itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack pkg-config**
