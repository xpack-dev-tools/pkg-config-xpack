...
named like **xPack pkg-config v{customField('xpackVersion')}** (mind the dash),
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/pkg-config@${customField('xpackVersion')}.${customField('npmSubversion')} latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/pkg-config@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack pkg-config v{customField('xpackVersion')} released**_
