...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/pkg-config-xpack.git
```
...
- open https://xpack-dev-tools.github.io/pkg-config-xpack/docs/maintainer/#publish-the-website in a separate window
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fpkg-config?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/pkg-config/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fpkg-config)](https://www.npmjs.com/package/@xpack-dev-tools/pkg-config/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fpkg-config)](https://www.npmjs.com/package/@xpack-dev-tools/pkg-config/)
