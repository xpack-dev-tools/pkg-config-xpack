...
const config: Config = {
  title: 'xPack pkg-config' +
    ((process.env.DOCUSAURUS_IS_PREVIEW === 'true') ? ' (preview)' : ''),
  tagline: 'A binary distribution of pkg-config',
  ...
  projectName: 'pkg-config-xpack', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/pkg-config-xpack/edit/xpack/website/',
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/pkg-config-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/pkg-config-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/pkg-config-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/pkg-config-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, pkg-config'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack-dev-tools/pkg-config-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          items: [
            {
              label: `pkg-config-xpack project`,
              href: `https://github.com/xpack-dev-tools/pkg-config-xpack/`,
            },
            {
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/pkg-config-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/pkg-config-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub pkg-config-xpack project',
              href: 'https://github.com/xpack-dev-tools/pkg-config-xpack/',
            },
            {
